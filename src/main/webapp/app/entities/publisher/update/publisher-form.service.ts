...
type PublisherFormGroupContent = {
  ...
  contact: FormControl<IPublisher['contact']>;
  website: FormControl<IPublisher['website']>;
  socialmedia: FormControl<IPublisher['socialmedia']>;
};
...
export class PublisherFormService {
  createPublisherFormGroup(publisher: PublisherFormGroupInput = { id: null }): PublisherFormGroup {
    ...
    return new FormGroup<PublisherFormGroupContent>({
      ...
      contact: new FormControl(publisherRawValue.contact, {
        validators: [Validators.required],
      }),
      website: new FormControl(publisherRawValue.website),
      socialmedia: new FormControl(publisherRawValue.socialmedia),
    });
  }
