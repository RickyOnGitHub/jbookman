...
type AuthorFormGroupContent = {
  ...
  writingstyle: FormControl<IAuthor['writingstyle']>;
  birthday: FormControl<IAuthor['birthday']>;
  website: FormControl<IAuthor['website']>;
  socialmedia: FormControl<IAuthor['socialmedia']>;
};
...
export class AuthorFormService {
  createAuthorFormGroup(author: AuthorFormGroupInput = { id: null }): AuthorFormGroup {
    ...
    return new FormGroup<AuthorFormGroupContent>({
      ...
      writingstyle: new FormControl(authorRawValue.writingstyle, {
        validators: [Validators.required],
      }),
      birthday: new FormControl(authorRawValue.birthday, {
        validators: [Validators.required],
      }),
      website: new FormControl(authorRawValue.website),
      socialmedia: new FormControl(authorRawValue.socialmedia),
    });
  }
