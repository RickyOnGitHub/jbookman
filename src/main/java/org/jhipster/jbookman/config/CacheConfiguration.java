...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.jhipster.jbookman.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.jhipster.jbookman.repository.UserRepository.USERS_BY_EMAIL_CACHE);
