...
import static org.jhipster.jbookman.web.rest.TestUtil.sameNumber;
...
class BookResourceIT {
    ...
    private static final String DEFAULT_ISBN_13 = "979303873164X";
    private static final String UPDATED_ISBN_13 = "225997818X";

    private static final Integer DEFAULT_PUBLISHINGYEAR = 0;
    private static final Integer UPDATED_PUBLISHINGYEAR = 1;

    private static final BigDecimal DEFAULT_LISTPRICE = new BigDecimal(0);
    private static final BigDecimal UPDATED_LISTPRICE = new BigDecimal(1);
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book()
            ...
            .publishingyear(DEFAULT_PUBLISHINGYEAR)
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book()
            ...
            .publishingyear(UPDATED_PUBLISHINGYEAR)
        ...
        Publisher publisher;
        if (TestUtil.findAll(em, Publisher.class).isEmpty()) {
            publisher = PublisherResourceIT.createUpdatedEntity(em);
            em.persist(publisher);
            em.flush();
        } else {
            publisher = TestUtil.findAll(em, Publisher.class).get(0);
    ...
    @Test
    @Transactional
    void checkEditionIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
    ...
    @Test
    @Transactional
    void checkIsbn13IsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        book.setIsbn13(null);
    ...
    @Test
    @Transactional
    void checkPublishingyearIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        book.setPublishingyear(null);
    ...
    void getAllBooks() throws Exception {
        ...
        restBookMockMvc
            ...
            .andExpect(jsonPath("$.[*].isbn13").value(hasItem(DEFAULT_ISBN_13)))
            .andExpect(jsonPath("$.[*].publishingyear").value(hasItem(DEFAULT_PUBLISHINGYEAR)))
            .andExpect(jsonPath("$.[*].listprice").value(hasItem(sameNumber(DEFAULT_LISTPRICE))));
    }
    ...
    void getBook() throws Exception {
        ...
        restBookMockMvc
            ...
            .andExpect(jsonPath("$.isbn13").value(DEFAULT_ISBN_13))
            .andExpect(jsonPath("$.publishingyear").value(DEFAULT_PUBLISHINGYEAR))
            .andExpect(jsonPath("$.listprice").value(sameNumber(DEFAULT_LISTPRICE)));
    }
    ...
    void partialUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.title(UPDATED_TITLE).listprice(UPDATED_LISTPRICE);
