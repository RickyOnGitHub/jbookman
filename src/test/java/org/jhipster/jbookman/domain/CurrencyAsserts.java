...
public class CurrencyAsserts {
    ...
    public static void assertCurrencyUpdatableFieldsEquals(Currency expected, Currency actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getAlphabeticcode()).as("check alphabeticcode").isEqualTo(actual.getAlphabeticcode()))
            .satisfies(e -> assertThat(e.getNumericcode()).as("check numericcode").isEqualTo(actual.getNumericcode()))
            .satisfies(e -> assertThat(e.getName()).as("check name").isEqualTo(actual.getName()))
            .satisfies(e -> assertThat(e.getMinorunit()).as("check minorunit").isEqualTo(actual.getMinorunit()));
    }
