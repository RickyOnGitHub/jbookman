...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '7a9ae2de-58a6-4c4a-bcf8-ea79d02cea2d' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('f661f7ba-3633-4eb3-87c8-100c247dbca1');
      cy.get(`[data-cy="name"]`).should('have.value', 'f661f7ba-3633-4eb3-87c8-100c247dbca1');
