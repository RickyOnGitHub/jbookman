...
describe('Author e2e test', () => {
  ...
  const authorSample = { name: 'masculine', writingstyle: 'NARRATIVE', birthday: '2024-09-21' };
  ...
  describe('new Author page', () => {
    ...
    it('should create an instance of Author', () => {
      cy.get(`[data-cy="name"]`).type('licence lovingly yippee');
      cy.get(`[data-cy="name"]`).should('have.value', 'licence lovingly yippee');

      cy.get(`[data-cy="writingstyle"]`).select('ACADEMIC');

      cy.get(`[data-cy="birthday"]`).type('2024-09-21');
      cy.get(`[data-cy="birthday"]`).blur();
      cy.get(`[data-cy="birthday"]`).should('have.value', '2024-09-21');

      cy.get(`[data-cy="website"]`).type('fondly');
      cy.get(`[data-cy="website"]`).should('have.value', 'fondly');

      cy.get(`[data-cy="socialmedia"]`).type('loads');
      cy.get(`[data-cy="socialmedia"]`).should('have.value', 'loads');
